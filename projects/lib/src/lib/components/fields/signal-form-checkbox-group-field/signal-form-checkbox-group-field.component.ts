...
@Component({
  ...
  standalone: true,
  imports: [NgClass],
  templateUrl: './signal-form-checkbox-group-field.component.html',
  styleUrl: './signal-form-checkbox-group-field.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SignalFormCheckboxGroupFieldComponent<
