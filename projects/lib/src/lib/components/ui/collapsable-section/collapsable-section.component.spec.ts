...
describe('CollapsableSectionComponent', () => {
  let spectator: Spectator<CollapsableSectionComponent>;

  const createComponent = createComponentFactory<CollapsableSectionComponent>({
    component: CollapsableSectionComponent,
    shallow: true,
