...
import { SignalFormPasswordFieldComponent } from './signal-form-password-field.component';

interface TestModel {
  password: string;
}

describe('SignalFormPasswordFieldComponent', () => {
  let spectator: Spectator<
    SignalFormPasswordFieldComponent<TestModel, 'password'>
  >;
  ...
  const createComponent = createComponentFactory<
    SignalFormPasswordFieldComponent<TestModel, 'password'>
  >({
    component: SignalFormPasswordFieldComponent,
    shallow: true,
  });
