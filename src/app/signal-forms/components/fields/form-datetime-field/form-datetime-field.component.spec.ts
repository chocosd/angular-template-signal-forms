...
import { FormDatetimeFieldComponent } from './form-datetime-field.component';

interface TestModel {
  birthDate: Date;
}

describe('FormDatetimeFieldComponent', () => {
  let spectator: Spectator<FormDatetimeFieldComponent<TestModel, 'birthDate'>>;
  let mockField: RuntimeDateTimeSignalField<TestModel, 'birthDate'>;
  let mockForm: SignalFormContainer<TestModel>;

  const createComponent = createComponentFactory<
    FormDatetimeFieldComponent<TestModel, 'birthDate'>
  >({
    component: FormDatetimeFieldComponent,
    shallow: true,
  });
