...
import { FormRatingFieldComponent } from './form-rating-field.component';

interface TestModel {
  rating: number;
}

describe('FormRatingFieldComponent', () => {
  let spectator: Spectator<FormRatingFieldComponent<TestModel, 'rating'>>;
  let mockField: RuntimeRatingSignalField<TestModel, 'rating'>;
  let mockForm: SignalFormContainer<TestModel>;

  const createComponent = createComponentFactory<
    FormRatingFieldComponent<TestModel, 'rating'>
  >({
    component: FormRatingFieldComponent,
    shallow: true,
